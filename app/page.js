  ...
  return (
    <div>
      ...
      <div className="main">
        <div>
          <h1 className="title">
            Welcome to ENS Testing {ens ? ens : address}!
          </h1>
          <div className="description">
            {/* Using HTML Entities for the apostrophe */}
            It&#39;s an NFT collection for ENS Testing.
          </div>
          {renderButton()}
        </div>
        <div>
          <img className="image" alt="" src="./bc.jpg" />
        </div>
      </div>

      <footer className="footer">Made with &#10084; by ENS Testing</footer>
    </div>
  );
}
